...
class TestUnifiedRouterCore:
    ...
    def test_get_tool_commands_cerebras_only(self):
        ...
        with patch('mcp_servers.slash_commands.unified_router.discover_slash_commands') as mock_discover:
...
class TestToolCallHandling:
    ...
    async def test_handle_tool_call_unknown_tool(self):
        ...
        with patch('mcp_servers.slash_commands.unified_router.get_tool_commands') as mock_get_commands:
    ...
    async def test_handle_tool_call_cerebras_special_case(self):
        ...
        with patch('mcp_servers.slash_commands.unified_router.get_tool_commands') as mock_get_commands:
            with patch('mcp_servers.slash_commands.unified_router.execute_direct_command') as mock_execute:
    ...
    async def test_handle_tool_call_argument_limit(self):
        ...
        from mcp_servers.slash_commands.unified_router import get_tool_commands
...
class TestMainServerSetup:
    ...
    async def test_main_server_initialization(self):
        ...
        with patch('mcp_servers.slash_commands.unified_router.FastMCP') as mock_fastmcp:
            with patch('mcp_servers.slash_commands.unified_router.create_tools') as mock_create_tools:
                # Setup mocks
...
class TestCommandArgumentParsing:
    ...
    def test_execute_direct_command_with_spaces_SHOULD_FAIL(self):
        ...
        """
        from mcp_servers.slash_commands.unified_router import execute_direct_command
